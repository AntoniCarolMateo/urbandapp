    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton("Next Step", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                    ...
                    //Acutalitzem els valors en la app
        ...
        radio_group_genere.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == R.id.radioButton_female){
                    Toast.makeText(getContext(), "choice : female", Toast.LENGTH_SHORT).show();
                }
                else if(checkedId == R.id.radioButton_male){
                    Toast.makeText(getContext(), "choice : male", Toast.LENGTH_SHORT).show();
